    ...
    content:[
  			new sap.ui.layout.form.SimpleForm({
				...
				content : 	[							
				 			...
				 			new sap.m.Label({text:"Name"}),
				 			new sap.m.Input("NewPhotoName",{ visible:false,type: sap.m.InputType.Input, maxLength:30,width:"300px"}),
            ...
            beforeOpen:function(){
            	if(selectedPhotoState!="Local"){
            		sap.ui.getCore().getElementById('NewPhotoName').etEditable(false)
            		...
            		sap.ui.getCore().getElementById('NewPhotoName').etEditable(true)
